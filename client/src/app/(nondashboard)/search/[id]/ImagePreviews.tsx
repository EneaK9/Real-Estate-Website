...
const ImagePreviews = ({ images, propertyName }: ImagePreviewsProps) => {
			...
			{images.map((image, index) => (
				<div
					...
					<img
						...
						className="object-cover cursor-pointer transition-transform duration-500 ease-in-out w-full h-full"
						onError={(e) => {
